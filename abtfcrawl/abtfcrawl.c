...
int main()
{
	...
	// Initialize motor stuff there
	// Initialize encoder stuff here
	...
	while(rc_get_state()!=EXITING){
		...
		if(rc_get_state()==RUNNING){
			...
			// Motor and encoder loop stuff
			// This code should set rc_set_state to running at some point
			printf("\nABTF Crawl is running\n");

			// start motor, stop motor based on time or encoder position
